...
class ProcessManager:
    ...
    def create(self, name: str, command: str, args: List[str] = None,
               working_dir: str = None, environment: Dict[str, str] = None) -> str:
    ...
    def list_processes(self, all_processes: bool = False) -> List[Dict[str, Any]]:
        ...
        for container in self.containers.values():
            if not all_processes and container.info.status in [ProcessStatus.EXITED, ProcessStatus.KILLED]:
                continue
            ...
            result.append({
                ...
                "created": container.info.created_at.strftime("%Y-%m-%d %H:%M:%S") if container.info.created_at else "",
    ...
    def inspect(self, process_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "created_at": container.info.created_at.isoformat() if container.info.created_at else None,
            "started_at": container.info.started_at.isoformat() if container.info.started_at else None,
            "finished_at": container.info.finished_at.isoformat() if container.info.finished_at else None,
    ...
    def logs(self, process_id: str, lines: Optional[int] = None, follow: bool = False) -> Optional[Dict[str, str]]:
    ...
    def run(self, name: str, command: str, args: List[str] = None,
