...
class BackendIntegrationTest {
    ...
    async testDatabaseOperations() {
        ...
        try {
            ...
            await this.runQuery(db, "SELECT name FROM sqlite_master WHERE type='table'");
        ...
        try {
            ...
            await this.runQuery(db, `
                INSERT INTO documents (id, filename, original_name, file_path, file_size, mime_type, upload_date, text_content, embedding_count, processing_status)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ...
            this.addResult('Document insertion', false, error.message);
        }
        ...
        try {
            ...
            this.addResult('Document retrieval', false, error.message);
        }
    }
        ...
        for (const file of testFiles) {
            ...
            try {
                const response = await fetch(`${this.apiBaseUrl}/upload`, {
                    method: 'POST',
                    body: this.createFormData([filePath])
                });
                ...
                if (result.success) {
                    ...
                    this.addResult(`File processing: ${file.name}`, false, result.error);
                }
            } catch (error) {
