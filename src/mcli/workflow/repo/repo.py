...
def loe(branch_a: str, branch_b: str):
    ...
    try:
        ...
        client = OpenAI(api_key="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")
