...
def test_add_model_from_url():
    ...
    try:
        ...
        test_model_url = "https://huggingface.co/microsoft/DialoGPT-small/resolve/main/pytorch_model.bin"
        test_tokenizer_url = "https://huggingface.co/microsoft/DialoGPT-small/resolve/main/tokenizer.json"
