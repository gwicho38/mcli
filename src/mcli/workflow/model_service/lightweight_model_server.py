...
class LightweightModelDownloader:
    ...
    def __init__(self, models_dir: str = "./lightweight_models"):
        ...
        self.session.headers.update({
            'User-Agent': 'MCLI-Lightweight-Model-Server/1.0'
        })
        ...
        class ModelHandler(BaseHTTPRequestHandler):
            ...
            def do_GET(self):
                ...
                if path == "/":
                    ...
                    self._send_response(200, {"status": "running", "models": list(loaded_models.keys())})
                elif path == "/models":
                    models = []
                    loaded_models = getattr(self.server_instance, 'loaded_models', {})
...
def main(model: Optional[str], auto: bool, port: int, list_models: bool, 
         create_client: bool, download_only: bool):
