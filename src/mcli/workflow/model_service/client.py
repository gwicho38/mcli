...
class ModelServiceClient:
    ...
    def load_model(self, name: str, model_type: str, model_path: str,
                   tokenizer_path: Optional[str] = None, device: str = "auto",
...
def load_model(model_path: str, url: str, name: str, model_type: str,
               tokenizer_path: str = None, device: str = 'auto',
               max_length: int = 512, temperature: float = 0.7,
