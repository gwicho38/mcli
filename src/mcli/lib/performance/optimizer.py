...
from mcli.lib.performance.uvloop_config import install_uvloop, get_event_loop_info
...
class PerformanceOptimizer:
    ...
    def get_optimization_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'successful_optimizations': sum(1 for opt in self.optimizations_applied.values() if opt.get('success', False)),
    ...
    def benchmark_performance(self, test_size: str = "small") -> Dict[str, Any]:
        ...
        if test_size == "small":
            ...
            documents = [f"test document {i} with much more content and details" for i in range(5000)]
