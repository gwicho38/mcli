...
class LocalDaemonClient:
    ...
    def list_commands(self) -> Dict[str, Any]:
        ...
        result = subprocess.run(self.daemon_cmd + ["list-commands", "--json"], capture_output=True, text=True)
    ...
    def execute_command(self, command_name: str, args: Optional[List[str]] = None) -> Dict[str, Any]:
