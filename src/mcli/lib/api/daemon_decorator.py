...
from .daemon_client import get_daemon_client, APIDaemonClient
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if result.get("success"):
                    ...
                    logger.warning(f"Daemon execution failed for '{cmd_name}': {result.get('error')}")
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if client.is_running():
                    logger.info(f"Daemon is running, but group '{grp_name}' will be executed locally")
