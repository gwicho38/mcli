...
def demo(demo_type: str):
    ...
    try:
        from mcli.lib.ui.visual_effects import (
            MCLIBanner, VisualTable, AnimatedSpinner, MCLIProgressBar,
            ColorfulOutput, StartupSequence, console, demo_visual_effects
        )
        ...
        if demo_type in ['all', 'tables']:
            ...
            sample_perf_data = {
                ...
                'rust': {'success': True, 'extensions': {
                    'tfidf': True, 'file_watcher': True, 
                    'command_matcher': True, 'process_manager': True
                }},
            ...
            rust_extensions = {
                'tfidf': True, 'file_watcher': True, 
                'command_matcher': False, 'process_manager': True
            }
...
def interactive():
    ...
    try:
        from mcli.lib.ui.visual_effects import (
            console, MCLIBanner, AnimatedSpinner, ColorfulOutput
        )
