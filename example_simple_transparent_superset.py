#!/usr/bin/env python3
"""
Example: Simple Transparent Click Superset with MCLI
...
if __name__ == "__main__":
    ...
    #    python example_simple_transparent_superset.py standardcli greet --name Alice
    #    python example_simple_transparent_superset.py standardcli show-file-info --file data.txt
    #
    # 2. Click commands with API endpoints:
    #    python example_simple_transparent_superset.py apicli greet-api --name Bob
    #    python example_simple_transparent_superset.py apicli file-info-api --file data.txt
    #
    # 3. Click commands with background processing:
    #    python example_simple_transparent_superset.py backgroundcli process-file-background --file data.txt
    #    python example_simple_transparent_superset.py backgroundcli long-task-background --task-name "test" --duration 10
    #
    # 4. Click commands with both API and background:
    #    python example_simple_transparent_superset.py fullcli process-file-full --file data.txt
    #
    # 5. Convenience decorators:
    #    python example_simple_transparent_superset.py conveniencecli health
    #    python example_simple_transparent_superset.py conveniencecli background-task --task-name "test"
    #
    # 6. All Click features:
    #    python example_simple_transparent_superset.py clickfeatures complex-command --verbose --count 3 "Hello World"
    #
    # 7. Start with API server:
    #    python example_simple_transparent_superset.py --start-server
    #
