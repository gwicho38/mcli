...
def enable_real_data_collection():
    ...
    if modifications_made > 0:
        ...
        print(
            "python -c \"import asyncio, sys; sys.path.insert(0, 'src'); from mcli.workflow.politician_trading.scrapers import run_uk_parliament_workflow; from mcli.workflow.politician_trading.config import WorkflowConfig; asyncio.run(run_uk_parliament_workflow(WorkflowConfig.default().scraping))\""
        )
